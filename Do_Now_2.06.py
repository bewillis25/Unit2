...
Answer the following
    ...
    2.  Can you remember something from Snap! that might allow that? The repeat block
...
Write responses for the following:
    1.  What happens when you run this code? It prints 'a' indefinetly

Try using other Boolean expressions instead of True (e.g. 4 > 5 and 9 != 2), and explore what happens.

    2.  How would you print out something 10 times? What about 100? What about 1,000? print('Something' * 1000)
